...
export const BIGQUERY_CONN = "looker_bqml_staging_bqml_accelerator_bigquery_connection_name"
export const GOOGLE_CLIENT_ID = "looker_bqml_staging_bqml_accelerator_google_client_id"
export const BQML_MODEL_DATASET_NAME = "looker_bqml_staging_bqml_accelerator_bqml_model_dataset_name"
export const GCP_PROJECT = "looker_bqml_staging_bqml_accelerator_gcp_project"
